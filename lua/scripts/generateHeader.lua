...
parser:flag("-l --list", "Automatically generate a widget list for the buttons")
...
local widgetButton = {
    ...
    text_label_unicode_strings_list = [[insurrection\ui\menus\chimera_servers_menu\strings\options.unicode_string_list]],
