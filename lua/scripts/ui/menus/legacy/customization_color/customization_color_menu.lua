...
local layout = widget.align("horizontal", constants.components.complexButton.normal.width, 59, yPosColors,
                            2)
...
return container("customization_color_menu", {
    ...
    },
    {
        options("customization_color_list", "horizontal", {
            {
                slider("color_left", "left", {func = "single_prev_cl_item_activated", legacy = true}),
                pos.options.x,
                yPosColors
            },
            {
