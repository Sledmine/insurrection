...
---@param props? {func?: string, branch?: true, conditionalWidgets?: invaderWidgetConditionalWidget[], dataInput?: string, eventsToChildren?: boolean, useItems?: boolean, campaignMaps?: boolean, multiplayerMaps?: string, gametypes: string, colorPicker?: boolean} Props of the component
---@return string
