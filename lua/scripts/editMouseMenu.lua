...
-- Edit menu container
widget.edit(
    [[insurrection\ui\menus\settings_menu\mouse_settings\mouse_settings_screen.ui_widget_definition]],
    {
        bounds = "0 0 480 856",
...
-- Edit options menu
widget.edit(
    [[insurrection\ui\menus\settings_menu\mouse_settings\mouse_options_menu.ui_widget_definition]],
    {
        bounds = "0 0 480 856",
        child_widgets = {
...
widget.edit(
    [[insurrection\ui\menus\settings_menu\mouse_settings\mouse_settings_help.ui_widget_definition]],
    settingsDescription())
