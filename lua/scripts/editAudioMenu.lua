...
-- Edit options menu
widget.edit(
    [[insurrection\ui\menus\settings_menu\audio_settings\audio_options_menu.ui_widget_definition]],
    {
        bounds = "0 0 480 856",
        child_widgets = {
...
widget.edit(
    [[insurrection\ui\menus\settings_menu\audio_settings\audio_settings_help.ui_widget_definition]],
    settingsDescription())
